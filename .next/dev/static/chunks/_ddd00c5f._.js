...
function useAuth() {
    ...
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])("/api/user/me", fetcher, {
    ...
    const updateProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAuth.useCallback[updateProfile]": async (name)=>{
...
_s(useAuth, "79HEVmThTxXDnvCRHvzjdvcbKa4=", false, function() {
    return [
...
function SignupForm() {
    ...
    const { signup } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(SignupForm, "GQssVf9HsVhaV9mNtV9f3xZKIkA=", false, function() {
    return [
...
//# sourceMappingURL=_ddd00c5f._.js.map